  ...
  modifyModalContent.innerHTML = `
      ...
      <form class="modifyModal__form">  
        <div class="addModal__input">   
          ...
          <img class="addModalInputImagePreview" src="" alt="Image preview"/>
          <input 
            value="Ajouter +"
            class="addModalField addModalInputImage" 
            type="file" 
...
function displayEditMode() {
  ...
  const modifyIntroButtons = document.querySelector(".modifyIntro__container");
